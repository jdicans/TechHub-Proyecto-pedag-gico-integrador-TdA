 ...
 */
router.post('/', auth_middleware_1.authMiddleware, reporte_controller_1.addReporte);
/**
 * @swagger
 * /api/reportes:
 *   get:
 ...
 *         description: Error del servidor
 */
router.get('/', auth_middleware_1.authMiddleware, (0, auth_middleware_1.requireRole)(1), reporte_controller_1.listReportes);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/mis-reportes', auth_middleware_1.authMiddleware, reporte_controller_1.getMisReportes);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/estado/:estado', auth_middleware_1.authMiddleware, (0, auth_middleware_1.requireRole)(1), reporte_controller_1.getReportesPorEstado);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/usuario/:id_usuario', auth_middleware_1.authMiddleware, (0, auth_middleware_1.requireRole)(1), reporte_controller_1.getReportesUsuario);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/publicacion/:id_publicacion', auth_middleware_1.authMiddleware, (0, auth_middleware_1.requireRole)(1), reporte_controller_1.getReportesPublicacion);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/comentario/:id_comentario', auth_middleware_1.authMiddleware, (0, auth_middleware_1.requireRole)(1), reporte_controller_1.getReportesComentario);
/**
 * @swagger
 * /api/reportes/{id}:
 *   get:
 ...
 *         description: Error del servidor
 */
router.get('/:id', auth_middleware_1.authMiddleware, reporte_controller_1.getReporte);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.put('/:id/estado', auth_middleware_1.authMiddleware, (0, auth_middleware_1.requireRole)(1), reporte_controller_1.cambiarEstadoReporte);
/**
 * @swagger
 * /api/reportes/{id}:
 *   put:
 ...
 *         description: Error del servidor
 */
router.put('/:id', auth_middleware_1.authMiddleware, (0, auth_middleware_1.requireRole)(1), reporte_controller_1.updateReporte);
/**
 * @swagger
 * /api/reportes/{id}:
 *   delete:
 ...
 *         description: Error del servidor
 */
router.delete('/:id', auth_middleware_1.authMiddleware, (0, auth_middleware_1.requireRole)(1), reporte_controller_1.deleteReporte);
