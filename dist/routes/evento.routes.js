 ...
 */
router.post('/', auth_middleware_1.authMiddleware, evento_controller_1.addEvento);
/**
 * @swagger
 * /api/eventos:
 *   get:
 ...
 *         description: Error del servidor
 */
router.get('/proximos', evento_controller_1.listEventosProximos);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/mis-eventos', auth_middleware_1.authMiddleware, evento_controller_1.getMyEventos);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/modalidad', evento_controller_1.getEventosByMode);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/categoria/:categoryId', evento_controller_1.getEventosByCategory);
/**
 * @swagger
 * /api/eventos/{id}:
 *   get:
 ...
 *         description: Error del servidor
 */
router.put('/:id', auth_middleware_1.authMiddleware, (0, auth_middleware_1.requireRole)(1), evento_controller_1.updateEventoController);
/**
 * @swagger
 * /api/eventos/{id}:
 *   delete:
 ...
 *         description: Error del servidor
 */
router.delete('/:id', auth_middleware_1.authMiddleware, (0, auth_middleware_1.requireRole)(1), evento_controller_1.deleteEventoController);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.post('/:id/inscribirse', auth_middleware_1.authMiddleware, evento_controller_1.inscribirse);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.delete('/:id/cancelar-inscripcion', auth_middleware_1.authMiddleware, evento_controller_1.cancelarInscripcionController);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/:id/inscritos', evento_controller_1.getInscritos);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/:id/inscritos/count', evento_controller_1.countInscritos);
