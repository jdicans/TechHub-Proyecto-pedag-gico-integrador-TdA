 ...
 */
router.post('/', auth_middleware_1.authMiddleware, archivo_controller_1.addArchivo);
/**
 * @swagger
 * /api/archivos:
 *   get:
 ...
 *         description: Error del servidor
 */
router.get('/', archivo_controller_1.listArchivos);
/**
 * @swagger
 * /api/archivos/tipo:
 *   get:
 ...
 *         description: Error del servidor
 */
router.get('/tipo', archivo_controller_1.getArchivosByMimeType);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/publicacion/:publicacionId', archivo_controller_1.getArchivosByPublicacionId);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/publicacion/:publicacionId/count', archivo_controller_1.countArchivos);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/publicacion/:publicacionId/size', archivo_controller_1.getTotalSize);
/**
 * @swagger
 * /api/archivos/{id}:
 *   get:
 ...
 *         description: Error del servidor
 */
router.get('/:id', archivo_controller_1.getArchivo);
/**
 * @swagger
 * /api/archivos/{id}:
 *   put:
 ...
 *         description: Error del servidor
 */
router.put('/:id', auth_middleware_1.authMiddleware, archivo_controller_1.updateArchivoController);
/**
 * @swagger
 * /api/archivos/{id}:
 *   delete:
 ...
 *         description: Error del servidor
 */
router.delete('/:id', auth_middleware_1.authMiddleware, archivo_controller_1.deleteArchivoController);
