 ...
 */
router.post('/', auth_middleware_1.authMiddleware, comentario_controller_1.addComentario);
/**
 * @swagger
 * /api/comentarios:
 *   get:
 ...
 *         description: Error del servidor
 */
router.get('/', comentario_controller_1.listComentarios);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/mis-comentarios', auth_middleware_1.authMiddleware, comentario_controller_1.getMyComentarios);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/publicacion/:publicacionId', comentario_controller_1.getComentariosByPublicacionId);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/publicacion/:publicacionId/count', comentario_controller_1.countComentarios);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/usuario/:userId', comentario_controller_1.getComentariosByUserId);
/**
 * @swagger
 * /api/comentarios/{id}:
 *   get:
 ...
 *         description: Error del servidor
 */
router.put('/:id', auth_middleware_1.authMiddleware, comentario_controller_1.updateComentarioController);
/**
 * @swagger
 * /api/comentarios/{id}:
 *   delete:
 ...
 *         description: Error del servidor
 */
router.delete('/:id', auth_middleware_1.authMiddleware, comentario_controller_1.deleteComentarioController);
