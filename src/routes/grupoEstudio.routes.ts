...
import {
  ...
  getMyGrupos,
  getGruposByUser,
  updateGrupoEstudioController,
  deleteGrupoEstudioController,
  addMiembro,
  removeMiembro,
  updateMiembroRolController,
  getMiembros,
  countMiembros,
} from '../controllers/grupoEstudio.controller';
 ...
 */
router.post('/', authMiddleware, addGrupoEstudio);
 ...
 *         description: Error del servidor
 */
router.get('/mis-grupos', authMiddleware, getMyGrupos);
 ...
 *         description: Error del servidor
 */
router.get('/usuario/:userId', getGruposByUser);
 ...
 *         description: Error del servidor
 */
router.put('/:id', authMiddleware, updateGrupoEstudioController);
 ...
 *         description: Error del servidor
 */
router.delete('/:id', authMiddleware, deleteGrupoEstudioController);
 ...
 *         description: Error del servidor
 */
router.get('/:id/miembros/count', countMiembros);
 ...
 *         description: Error del servidor
 */
router.post('/:id/miembros', authMiddleware, addMiembro);
 ...
 *         description: Error del servidor
 */
router.delete('/:id/miembros/:userId', authMiddleware, removeMiembro);
 ...
 *         description: Error del servidor
 */
router.put('/:id/miembros/:userId/rol', authMiddleware, updateMiembroRolController);
