 ...
 *         description: Error del servidor
 */
router.get('/', authMiddleware, listUsuarios);
 ...
 *         description: Error del servidor
 */
router.put('/:id', authMiddleware, updateUsuarioController);
 ...
 *         description: Error del servidor
 */
router.delete('/:id', authMiddleware, requireRole(1), deleteUsuarioController);
